...
export const AnnouncementBar: React.FC = () => {
  ...
  const text = announcement?.text || settings?.announcement_center || 'Royal Mail Tracked 24/48 UK Dispatch • Free UK Delivery on Orders Over £25 • 30-Day Returns';
  ...
  return (
    <div
      className="text-xs py-2 px-3 sm:px-4 border-b border-white/10 transition-colors"
      style={{ backgroundColor: bg, color: textColor }}
    >
      <div className="max-w-container mx-auto flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 mx-auto sm:mx-0 font-medium text-center truncate">
