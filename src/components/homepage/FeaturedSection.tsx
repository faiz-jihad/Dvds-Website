      ...
      <div className={`grid gap-6 sm:gap-8 ${colSpanClass}`}>
        {collections.map((item, index) => {
          ...
          return (
            ...
            >
              <SpotlightCard className="h-full overflow-hidden rounded-xl bg-white border border-gray-200/80 shadow-xs hover:shadow-xl hover:border-brand-blue/40 transition-all duration-300">
                <Link
                  to={item.href || '/shop'}
